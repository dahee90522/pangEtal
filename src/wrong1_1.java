...
public class wrong1_1 extends JFrame {
	...
	public wrong1_1(int imgnum, int quiznum) {//
		...
		setResizable(false);
		if(imgnum==1)startScreen = new ImageIcon("images/backgrounds/wrong2.png");//각성 전
		if(imgnum==2)startScreen = new ImageIcon("images/backgrounds/Gwrong2.png");//각성 후
		...
		ImageIcon r1_default = new ImageIcon("images/buttons/itsOkay_default.png"); //게임시작 기본
		ImageIcon r1_rollover=new ImageIcon("images/buttons/itsOkay_rollover.png"); //게임시작 마우스 올렸을 때
		...
		btn1.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                new wrong1_2(imgnum); // 클래스 newWindow를 새로 만들어낸다
                dispose();
			}
		});
		setContentPane(scrollPane);
		ImageIcon r2_default = new ImageIcon("images/buttons/retry_default.png"); //게임시작 기본
		ImageIcon r2_rollover=new ImageIcon("images/buttons/retry_rollover.png"); //게임시작 마우스 올렸을 때
		...
		btn2.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
            	switch(quiznum) {//문제를 다시 풀 경우에 그 문제로 가기 위한 switchcase
