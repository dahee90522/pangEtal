...
public class quiz3 extends JFrame{
	...
	public quiz3() {
			...
			setResizable(false);
			startScreen = new ImageIcon("images/backgrounds/quiz3.png");
			...
			ImageIcon answer1_default = new ImageIcon("images/buttons/quiz3-1_default.png"); //게임시작 기본
			ImageIcon answer1_rollover=new ImageIcon("images/buttons/quiz3-1_rollover.png"); //게임시작 마우스 올렸을 때
			ImageIcon answer2_default = new ImageIcon("images/buttons/quiz3-2_default.png"); //게임시작 기본
			ImageIcon answer2_rollover=new ImageIcon("images/buttons/quiz3-2_rollover.png"); //게임시작 마우스 올렸을 때
			ImageIcon answer3_default = new ImageIcon("images/buttons/quiz3-3_default.png"); //게임시작 기본
			ImageIcon answer3_rollover=new ImageIcon("images/buttons/quiz3-3_rollover.png"); //게임시작 마우스 올렸을 때
